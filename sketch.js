...
var message4 = "Press space to ring your cycle's bell. Have fun!";
...
function preload() {
  ...
  player1img = loadAnimation("opponent1.png", "opponent2.png");
  player2img = loadAnimation("opponent4.png", "opponent5.png");
  player3img = loadAnimation("opponent7.png", "opponent8.png");
...
function draw() {
  ...
  text(message1, 40, 238);
  text(message2, 40, 255);
  text(message3, 40, 272);
  text(message4, 40, 289);
  ...
  if (gameState === PLAY) {
    ...
    value = 0;
      ...
      message4 = "Press space to ring your cycle's bell. Have fun!"  
      value = 1;
      }
